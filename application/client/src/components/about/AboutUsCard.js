/* This file holds the component that shows a developer's card on the About Us page.
 * Clicking on the card takes the user to the clicked on developer's personal About Me page. */
