/* Privacy Policy Source: https://www.privacypolicytemplate.net */
...
export default function PrivacyPolicy() {
    return (
        <div className="privacy-policy-page">
            ...
            <h3>1. Preface</h3>
            <p>
                Gatormmunity operates the http://54.241.101.69/ website, which provides the SERVICE. <br /><br />
            ...
            <p>
                ...
                certain personally identifiable information, including but not limited to your
                name, email address, and SFSU ID number. The information that we collect will be used
            ...
            <p>
                ...
                Our website uses these "cookies" to collect information and to improve our Service. If you disable our cookies,
            ...
            <p>
                ...
                This privacy policy was last modified on October 25, 2022, 22:30 PST.
            </p>
        </div>
    );
}