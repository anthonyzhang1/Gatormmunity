 ...
 */
UserModel.addNewUser = (first_name, last_name, email, sfsu_id_number, sfsu_id_picture_path,
	...
	return database
		.query(insertUserSQL, [first_name, last_name, email, sfsu_id_number, sfsu_id_picture_path,
							   profile_picture_path, profile_picture_thumbnail_path, role])
		.then(([results]) => {
