...
export default function Home() {
    ...
    // determines whether to hide or show the register modal
    ...
    return (
        <div className="home-page">
            ...
            <div className="slogan-div">
                ...
                {!userSession &&
                    <Button className='slogan-register-button default-button-color' onClick={() => setRegisterModalShow(true)}>
                        See why
                    </Button>
                }
            </div>
            ...
            <Container fluid className="features-container">
                ...
                <Row className="features-row-2">
                    ...
                    <Col className="features-col-gator-chat features-box">
                        <h3 className="feature-title">Gator Chat</h3>
                        <p className="feature-body">
            ...
            {/* Displays/hides the register modal. */}
