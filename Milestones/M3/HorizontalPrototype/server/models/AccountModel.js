...
AccountModel.authenticate = (sfsu_id_number, plaintextPassword) => {
    ...
    const loginSQL = `SELECT u.user_id, u.first_name, u.last_name, u.profile_picture_path, u.profile_picture_thumbnail_path,
                             u.role, u.join_date, a.password
    ...
    return database
        ...
        .then(([results]) => {
            ...
            if (results.length > 0) {
                ...
                returnData.last_name = results[0].last_name;
                ...
                returnData.join_date = results[0].join_date;
